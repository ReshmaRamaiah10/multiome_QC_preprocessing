...
for (sample_name in sample_names) {
    ...
    proj <- loadArchRProject('pre_filt')
    ...
    # subset project
    proj_name <- 'cr_filt'
    sub_proj <- subsetCells(ArchRProj = proj, cellNames = cr_barcodes$barcode)
    saveArchRProject(ArchRProj = sub_proj, outputDirectory = proj_name)
